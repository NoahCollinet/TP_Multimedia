   ...
   for (int i=0; i < nTaille3; i+=3)
     {
       ...
       ImgOut[i+1]=(ImgInY[taille]-0.34414*(ImgInCb[taille]-128)-0.714414*(ImgInCr[taille]-128))>255? 255 : ImgInY[taille]-0.34414*(ImgInCb[taille]-128)-0.714414*(ImgInCr[taille]-128)<0? 0 : ImgInY[taille]-0.34414*(ImgInCb[taille]-128)-0.714414*(ImgInCr[taille]-128);
       ImgOut[i+2]=(ImgInY[taille]+1.772*(ImgInCb[taille]-128))>255? 255 : (ImgInY[taille]+1.772*(ImgInCb[taille]-128))<0? 0 : ImgInY[taille]+1.772*(ImgInCb[taille]-128);
       taille++;   
     }
